...
class ReposControllerTest < ActionController::TestCase
  ...
  test "should create repo" do
    assert_difference('Repo.count') do
      post :create, repo: { has_readme_file: @repo.has_readme_file, name: @repo.name, size: @repo.size }
    end
  ...
  test "should update repo" do
    patch :update, id: @repo, repo: { has_readme_file: @repo.has_readme_file, name: @repo.name, size: @repo.size }
    assert_redirected_to repo_path(assigns(:repo))
  end
